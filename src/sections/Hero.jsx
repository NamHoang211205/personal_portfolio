    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/NamHoang211205" },
                { icon: Linkedin, href: "https://www.linkedin.com/in/nam-hoang-2b7286272/" },
                { icon: Instagram, href: "https://www.instagram.com/hgnammm___/?hl=en" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
        ...
        <div className="mt-20 animate-fade-in animation-delay-600">
          <p className="text-default text-muted-foreground mb-6 text-center">
